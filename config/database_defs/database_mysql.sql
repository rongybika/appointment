...
DROP TABLE IF EXISTS `rssnewsreader_phpauth_config`;
...
INSERT INTO `rssnewsreader_phpauth_config` (`setting`, `value`) VALUES
  ...
  ('table_attempts',  'rssnewsreader_phpauth_attempts'),
  ('table_requests',  'rssnewsreader_phpauth_requests'),
  ('table_sessions',  'rssnewsreader_phpauth_sessions'),
  ('table_users', 'rssnewsreader_phpauth_users'),
  ('table_emails_banned', 'rssnewsreader_phpauth_emails_banned'),
  ('table_translations', 'rssnewsreader_phpauth_translation_dictionary'),
...
DROP TABLE IF EXISTS `rssnewsreader_phpauth_attempts`;
...
DROP TABLE IF EXISTS `rssnewsreader_phpauth_requests`;
...
DROP TABLE IF EXISTS `rssnewsreader_phpauth_sessions`;
...
DROP TABLE IF EXISTS `rssnewsreader_phpauth_users`;
...
DROP TABLE IF EXISTS `rssnewsreader_phpauth_emails_banned`;
